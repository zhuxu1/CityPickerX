...
[ ![Download](https://api.bintray.com/packages/zhuxu820/Utils/CityPickerX/images/download.svg?version=0.2.0) ](https://bintray.com/zhuxu820/Utils/CityPickerX/0.2.0/link)
...
```
```
implementation 'com.utils.cocoz:citypickerx:0.2.0'
```
```
<dependency org="com.utils.cocoz" name="citypickerx" rev="0.2.0">
